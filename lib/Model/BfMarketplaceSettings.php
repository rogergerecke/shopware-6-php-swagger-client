 ...
 */
class BfMarketplaceSettings implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'BfMarketplaceSettings';
    ...
    public function setId($id)
    {
        ...
        if (!is_null($id) && (!preg_match("/^[0-9a-f]{32}$/", $id))) {
            throw new \InvalidArgumentException("invalid value for $id when calling BfMarketplaceSettings., must conform to the pattern /^[0-9a-f]{32}$/.");
        }
    ...
    public function setBfMarketplaceId($bf_marketplace_id)
    {
        ...
        if ((!preg_match("/^[0-9a-f]{32}$/", $bf_marketplace_id))) {
            throw new \InvalidArgumentException("invalid value for $bf_marketplace_id when calling BfMarketplaceSettings., must conform to the pattern /^[0-9a-f]{32}$/.");
        }
    ...
    public function setCurrencyId($currency_id)
    {
        ...
        if ((!preg_match("/^[0-9a-f]{32}$/", $currency_id))) {
            throw new \InvalidArgumentException("invalid value for $currency_id when calling BfMarketplaceSettings., must conform to the pattern /^[0-9a-f]{32}$/.");
        }
    ...
    public function setLanguageId($language_id)
    {
        ...
        if ((!preg_match("/^[0-9a-f]{32}$/", $language_id))) {
            throw new \InvalidArgumentException("invalid value for $language_id when calling BfMarketplaceSettings., must conform to the pattern /^[0-9a-f]{32}$/.");
        }
    ...
    public function setCountryId($country_id)
    {
        ...
        if ((!preg_match("/^[0-9a-f]{32}$/", $country_id))) {
            throw new \InvalidArgumentException("invalid value for $country_id when calling BfMarketplaceSettings., must conform to the pattern /^[0-9a-f]{32}$/.");
        }
