...
class Success implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    protected static $openAPITypes = [
        ...
        'included' => '\OpenAPI\Client\Model\Resource[]'
    ];
     ...
     * Sets links
     *
     * @param array|null $links Link members related to the primary data.
     *
     * @return self
     */
     ...
     * Sets included
     *
     * @param \OpenAPI\Client\Model\Resource[]|null $included To reduce the number of HTTP requests, servers **MAY** allow responses that include related resources along with the requested primary resources. Such responses are called \"compound documents\".
     *
     * @return self
     */
