 ...
 */
class BfConfig implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'BfConfig';
    ...
    public function setId($id)
    {
        ...
        if (!is_null($id) && (!preg_match("/^[0-9a-f]{32}$/", $id))) {
            throw new \InvalidArgumentException("invalid value for $id when calling BfConfig., must conform to the pattern /^[0-9a-f]{32}$/.");
        }
     ...
     *
     * @param object|null $configuration_value configuration_value
     *
     * @return self
     */
