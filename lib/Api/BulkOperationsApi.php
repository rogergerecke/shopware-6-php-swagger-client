...
class BulkOperationsApi
{
     ...
     */
    public function sync($inline_object, $fail_on_error = true, $single_operation = false, $indexing_behavior = null)
    {
        list($response) = $this->syncWithHttpInfo($inline_object, $fail_on_error, $single_operation, $indexing_behavior);
        return $response;
    }
     ...
     */
    public function syncWithHttpInfo($inline_object, $fail_on_error = true, $single_operation = false, $indexing_behavior = null)
    {
        $request = $this->syncRequest($inline_object, $fail_on_error, $single_operation, $indexing_behavior);
     ...
     */
    public function syncAsync($inline_object, $fail_on_error = true, $single_operation = false, $indexing_behavior = null)
    {
        return $this->syncAsyncWithHttpInfo($inline_object, $fail_on_error, $single_operation, $indexing_behavior)
            ->then(
                function ($response) {
                    return $response[0];
                }
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function syncAsyncWithHttpInfo($inline_object, $fail_on_error = true, $single_operation = false, $indexing_behavior = null)
    {
        $returnType = '\OpenAPI\Client\Model\InlineResponse2006';
        $request = $this->syncRequest($inline_object, $fail_on_error, $single_operation, $indexing_behavior);
     ...
     */
    public function syncRequest($inline_object, $fail_on_error = true, $single_operation = false, $indexing_behavior = null)
    {
        // verify the required parameter 'inline_object' is set
        if ($inline_object === null || (is_array($inline_object) && count($inline_object) === 0)) {
            throw new \InvalidArgumentException(
                'Missing the required parameter $inline_object when calling sync'
            );
        }
